...
export const SPECIES = [
  ...
  },
  {
    ...
    // the two gnomes that are IN the photo inpainted away) and `artAnimLayers` full-frame
    // overlay layers (`-g1…-gN.webp`, one per gnome) carry the motion. g1/g2 are the two
    // gnomes down among the stems; g3/g4 are two extra gnomes painted in behind the mushroom
    // CAPS that duck out of sight and lift their heads back up. Built by
    // scripts/{remove_gnomes,add_cap_gnomes,build_gnome_layers,build_gnome_anim}.py.
