...
export const SPECIES = [
  ...
  },
  {
    ...
    // Animated detail-view portrait: the photo itself is a STATIC plate with the two
    // garden gnomes inpainted away (`<img>-base.jpg`), and two full-frame overlay layers
    // (`-g1.png` / `-g2.png`, one per gnome) fade in and out so the gnomes peek and hide.
    // Plates are generated by scripts/remove_gnomes.py + scripts/build_gnome_layers.py.
    artAnim: 'gnomes',
