...
const MOUNTAIN_W_CELLS = 5;        // sprite width in cells (the sprite tapers to feet, so it reads ~4-5 tiles wide)
const MOUNTAIN_EMBED_FRAC = 0.07;  // just tuck the feet under the soil line (sprite already tapers, no buried base to hide)
